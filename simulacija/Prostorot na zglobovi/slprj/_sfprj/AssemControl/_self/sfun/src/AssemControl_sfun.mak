...
MACHINE     = AssemControl
TARGET      = sfun
CHART_SRCS 	= c2_AssemControl.c
MACHINE_SRC	= AssemControl_sfun.c
MACHINE_REG = AssemControl_sfun_registry.c
MAKEFILE    = AssemControl_sfun.mak
...
OBJLIST_FILE = AssemControl_sfun.mol
