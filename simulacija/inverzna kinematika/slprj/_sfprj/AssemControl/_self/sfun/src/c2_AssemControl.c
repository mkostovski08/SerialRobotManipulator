  ...
  c2_chartNumber)
{
  _SFD_SCRIPT_TRANSLATION(c2_chartNumber, 0U, sf_debug_get_script_id(
    "C:/Users/Martin/Desktop/dipl/D 2/obid 10/Direktnata kinematika i Jakobijanot/qd2xyz.m"));
}
...
const mxArray *sf_c2_AssemControl_get_eml_resolved_functions_info(void)
{
  ...
  (*c2_b_info)[0].resolved =
    "[E]C:/Users/Martin/Desktop/dipl/D 2/obid 10/Direktnata kinematika i Jakobijanot/qd2xyz.m";
...
static void mdlSetWorkWidths_c2_AssemControl(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3076355055U));
  ssSetChecksum1(S,(3910931010U));
  ssSetChecksum2(S,(2739056060U));
  ssSetChecksum3(S,(2508537958U));
